...
// 如果希望根治这个问题，可以采用物理路径解决  dirname(__FILE__) 当前文件夹物理路径

require_once '../mysql.php';
require_once '../functions.php';
$current_page = isset($current_page) ? $current_page : '';
$current_user = xiu_get_current_user();
$avatar=mysql("select avatar,nickname from users where email = '{$current_user}';");
//echo $avatar['avatar'];
?>
<div class="aside">
  <div class="profile">
    <img class="avatar" src="<?php echo $avatar['avatar']; ?>">
    <h3 class="name"><?php echo $avatar['nickname']; ?></h3>
  </div>
  <ul class="nav">
